...
# PRIMEIRA PARTE DO JOGO (INTRODUÇÃO E PRIMEIRA INTERAÇÃO)
    scene cenario1
    with dissolve
    ...
    show maria1
    with dissolve
    narrador "Esta é Maria, uma senhora doente a procura de um alívio para suas fortes dores."
    scene cenario6
    with dissolve
    ...
    with dissolve
    narrador "O portal está se abrindo para que os viajantes tentem chegar até forte da sorte."
    stop sound
    scene fundofloresta
...
nosso objetivo, vamos, temos um longo caminho pela frente!."
    ...
    #PRIMEIRO DESAFIO
    estatua"Paga-me com suas dores, bem-vindos ao seu primeiro desafio, nesse desafio um de vocês será
escolhido para enfrentar uma criatura mágica"
    ...
    menu:
        "Ana":
            ...
            ana"Irei derrotar essa fera e vamos conseguir prosseguir!"
            ...
            show estatua1 at right
            with dissolve
            estatua"Esse desafio requer que um dos participantes sofra e que me pague com esse sofrimento,
vocês passaram e estão prontos para o próximo desafio."
        ...
        "Maria":
            ...
            show monstro at left
            maria"Irei derrotar essa fera e vamos conseguir prosseguir!"
            play sound "somFeitico.mp3"
...
vocês passaram e estão prontos para o próximo desafio."
        ...
        "Amanda":
            ...
            show monstro at left
            amanda"Irei derrotar essa fera e vamos conseguir prosseguir!"
            play sound "somFeitico.mp3"
